...
Namespace Global.WinForms.Ribbon
    Partial Class RibbonItems
        Private Class Cmd
            Public Const cmdQAT As UInteger = 1006
            ...
            Public Const cmdTabMain As UInteger = 1004
            Public Const cmdGroupFileActions As UInteger = 1005
            Public Const cmdCustomizeQAT As UInteger = 1007
        End Class
