...
namespace WinForms.Actions
{
    ...
    public partial class MenuAction : System.ComponentModel.Component
    {
        ...
        internal MenuActionList _owner = null;
        ...
        /// </summary>
        public MenuAction(System.ComponentModel.IContainer container)
        {
            container.Add(this);
            InitializeComponent();
        }
        ...
        /// <summary>
        /// The text used in controls associated to this MenuAction.
        /// </summary>
        [
        Category("Misc"),
        Localizable(true),
        ...
        public string Text
        {
            ...
            set
            {
                ...
                while (i.MoveNext())
                {
                    ((MenuActionData)i.Value).Text = _text;
                }
            }
        }
        /// <summary>
        ...
        public bool Enabled
        {
            ...
            set
            {
                ...
                while (i.MoveNext())
                {
                    ((MenuActionData)i.Value).Enabled = _enabled;
                }
            }
        }
        /// <summary>
        ...
        public bool Checked
        {
            ...
            set
            {
                ...
                while (i.MoveNext())
                {
                    ((MenuActionData)i.Value).Checked = _checked;
                }
            }
        }
        /// <summary>
        /// Indicates the shortcut for this MenuAction.
        /// used for MenuItem and 
        /// </summary>
        [
        DefaultValue(Shortcut.None),
        Category("Misc"),
        Description("Indicates the shortcut for this MenuAction.")
        ]
        public Shortcut Shortcut
        {
            ...
            set
            {
                ...
                while (i.MoveNext())
                {
                    ((MenuActionData)i.Value).Shortcut = _shortcut;
                }
            }
        }
        /// <summary>
        /// Indicates the shortcutKeys for this MenuAction.
        /// used for ToolStripMenuItem
        /// </summary>
        [
        DefaultValue(Keys.None),
		Category("Misc"),
        Description("Indicates the shortcutKeys for this MenuAction.")
        ]
        public Keys ShortcutKeys
        {
            ...
            set
            {
                ...
                while (i.MoveNext())
                {
                    ((MenuActionData)i.Value).ShortcutKeys = _shortcutKeys;
                }
            }
        }
        /// <summary>
        ...
        public bool Visible
        {
            ...
            set
            {
                ...
                while (i.MoveNext())
                {
                    ((MenuActionData)i.Value).Visible = _visible;
                }
            }
        }
        /// <summary>
        /// User defined data associated with this MenuAction.
        /// </summary>
        [
        DefaultValue(null),
		Category("Data"),
        Description("User defined data associated with this MenuAction.")
        ]
        public object Tag
        {
            get
        ...
        /// <summary>
        /// Indicates the index of the image in the parent MenuActionList's ImageList this MenuAction will use to obtains its image.
        /// </summary>
        [
        Category("Misc"),
        Localizable(true),
        Description("Indicates the index of the image in the parent MenuActionList's ImageList this MenuAction will use to obtains its image."),
        ...
        public int ImageIndex
        {
            ...
            set
            {
                ...
                while (i.MoveNext())
                {
                    ((MenuActionData)i.Value).ImageIndex = _imageIndex;
                }
            }
        }
        /// <summary>
        ...
        public string Hint
        {
            ...
            set
            {
                ...
                while (i.MoveNext())
                {
                    ((MenuActionData)i.Value).Hint = _hint;
                }
            }
        }
        /// <summary>
        ...
        internal ImageList ImageList
        {
            set
            {
                ...
                while (i.MoveNext())
                {
                    ((MenuActionData)i.Value).ImageList = value;
                }
            }
        }
        /// <summary>
        ...
        {
            MenuActionData ad = (MenuActionData)_components[comp];

            if (add)
            {
                if (ad == null)
                {
                    ad = new MenuActionData();
        ...
        internal bool ShowTextOnToolBar
        {
            set
            {
                ...
                while (i.MoveNext())
                {
                    ((MenuActionData)i.Value).ShowTextOnToolBar = dtext;
                }
            }
        }
        #endregion
        ...
        internal void FinishInit()
        {
            ...
            while (i.MoveNext())
            {
                ((MenuActionData)i.Value).FinishInit();
            }
#endif
        }
    }
    ...
    /// <summary>
    /// Internal data about a control used by an MenuAction
    /// </summary>
    internal class MenuActionData : IDisposable
    {
        #region member variables
        ...
        #endregion
        #region "public" interface
        internal void Attach(MenuAction a, Component o, bool designMode)
        {
