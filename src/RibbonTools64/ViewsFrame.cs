...
namespace UIRibbonTools
{
    partial class ViewsFrame : UserControl
    {
        ...
        private void TreeViewRibbonChange(object sender, TreeViewEventArgs e)
        {
            ...
            switch (_currentObject.ObjectType())
            {
                case RibbonObjectType.ApplicationMenu:
                    {
                        _currentFrame = AddCurrentFrame<ApplicationMenuFrame>();
                        _actionRemove.Enabled = false;
                        break;
                    }

                case RibbonObjectType.Button:
                    _currentFrame = AddCurrentFrame<ButtonFrame>();
                    break;

                case RibbonObjectType.ToggleButton:
                    _currentFrame = AddCurrentFrame<ToggleButtonFrame>();
                    break;
                case RibbonObjectType.SplitButton:
                    _currentFrame = AddCurrentFrame<SplitButtonFrame>();
                    break;
                case RibbonObjectType.DropDownButton:
                    _currentFrame = AddCurrentFrame<DropDownButtonFrame>();
                    break;
                case RibbonObjectType.QuickAccessToolbar:
                    {
                        _currentFrame = AddCurrentFrame<QuickAccessToolbarFrame>();
                        _actionRemove.Enabled = false;
                        break;
                    }
                ...
                case RibbonObjectType.HelpButton:
                    {
                        _currentFrame = AddCurrentFrame<HelpButtonFrame>();
                        _actionRemove.Enabled = false;
                        break;
                    }

                case RibbonObjectType.Tab:
                    _currentFrame = AddCurrentFrame<TabFrame>();
                    break;
                case RibbonObjectType.TabGroup:
                    _currentFrame = AddCurrentFrame<TabGroupFrame>();
                    break;
                case RibbonObjectType.Group:
                    _currentFrame = AddCurrentFrame<GroupFrame>();
                    break;
                ...
                case RibbonObjectType.QatInRibbonGallery:
                    _currentFrame = AddCurrentFrame<QatControlFrame>();
                    break;
                case RibbonObjectType.DropDownGallery:
                    _currentFrame = AddCurrentFrame<DropDownGalleryFrame>();
                    break;
                case RibbonObjectType.SplitButtonGallery:
                    _currentFrame = AddCurrentFrame<SplitButtonGalleryFrame>();
                    break;
                case RibbonObjectType.InRibbonGallery:
                    _currentFrame = AddCurrentFrame<InRibbonGalleryFrame>();
                    break;
                case RibbonObjectType.MenuGroup:
                case RibbonObjectType.MiniToolbarMenuGroup:
                    _currentFrame = AddCurrentFrame<MenuGroupFrame>();
                    break;
                case RibbonObjectType.AppMenuGroup:
                    _currentFrame = AddCurrentFrame<AppMenuGroupFrame>();
                    break;
                case RibbonObjectType.Scale:
                    _currentFrame = AddCurrentFrame<ScaleFrame>();
                    break;
                case RibbonObjectType.ViewRibbon:
                    {
                        _currentFrame = AddCurrentFrame<ViewRibbonFrame>();
                        _actionRemove.Enabled = false;
                        break;
                    }
                ...
                case RibbonObjectType.RibbonSizeDefinition:
                    _currentFrame = AddCurrentFrame<SizeDefinitionFrame>();
                    break;
                case RibbonObjectType.GroupSizeDefinition:
                    _currentFrame = AddCurrentFrame<GroupSizeDefinitionFrame>();
                    break;
                case RibbonObjectType.ControlSizeDefinition:
                    _currentFrame = AddCurrentFrame<ControlSizeDefinitionFrame>();
                    break;
                case RibbonObjectType.ColumnBreak:
                    _currentFrame = AddCurrentFrame<ColumnBreakFrame>();
                    break;
                case RibbonObjectType.FloatieFontControl:
                    _currentFrame = AddCurrentFrame<FloatieFontControlFrame>();
                    break;
                case RibbonObjectType.FontControl:
                    _currentFrame = AddCurrentFrame<FontControlFrame>();
                    break;
                case RibbonObjectType.ControlGroup:
                    _currentFrame = AddCurrentFrame<ControlGroupFrame>();
                    break;
                case RibbonObjectType.ComboBox:
                    _currentFrame = AddCurrentFrame<ComboBoxFrame>();
                    break;
                case RibbonObjectType.CheckBox:
                    _currentFrame = AddCurrentFrame<CheckBoxFrame>();
                    break;
                case RibbonObjectType.DropDownColorPicker:
                    _currentFrame = AddCurrentFrame<DropDownColorPickerFrame>();
                    break;
                case RibbonObjectType.Spinner:
                    _currentFrame = AddCurrentFrame<SpinnerFrame>();
                    break;
                case RibbonObjectType.MiniToolbar:
                    _currentFrame = AddCurrentFrame<MiniToolbarFrame>();
                    break;
                case RibbonObjectType.ContextMenu:
                    _currentFrame = AddCurrentFrame<ContextMenuFrame>();
                    break;
                case RibbonObjectType.ContextMap:
                    _currentFrame = AddCurrentFrame<ContextMapFrame>();
                    break;
        ...
        {
            (sender as MenuAction).Enabled = (treeViewRibbon.SelectedNode != null);
        }
