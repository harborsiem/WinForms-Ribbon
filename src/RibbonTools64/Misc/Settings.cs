...
namespace UIRibbonTools
{
    class Settings
    {
                    ...
                    foreach (XElement ele in root.Elements())
                    {
                        switch (ele.Name.LocalName)
                        {
                            ...
                            case Attributes.Height:
                                ...
                                break;
                            case Attributes.RibbonFramework:
                                RibbonFramework = XmlConvert.ToBoolean(ele.Value);
                                break;
                        }
                    }
                    modified = false;
        ...
        public void Write()
        {
            if (_modified)
            {
                ...
                try
                {
                    ...
                    writer.WriteStartElement(Attributes.RibbonFramework);
                    writer.WriteString(XmlConvert.ToString(RibbonFramework));
                    writer.WriteEndElement();
        ...
        private static class Attributes
        {
            ...
            public const string RibbonFramework = nameof(RibbonFramework);
        }
    }
}
