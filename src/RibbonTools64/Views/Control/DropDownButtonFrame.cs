...
namespace UIRibbonTools
{
    ...
    partial class DropDownButtonFrame : ControlFrame
    {
        private static Image sample = ImageManager.DropDownButtonSample();

        public DropDownButtonFrame()
        {
        ...
        protected override void InitComponentStep2()
        {
            ...
            LabelHeader.Text = "  DropDownButton Properties";
            LabelHeader.ImageIndex = 3;
        }
