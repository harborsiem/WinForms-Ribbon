...
namespace UIRibbonTools
{
    partial class BaseFrame : UserControl
    {
        ...
        protected virtual void InitComponentStep1()
        {
            ...
            _viewsTip = new ToolTip(components);
        ...
        protected virtual void InitComponentStep2()
        {
            ...
            this._layoutPanel.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 150F));
        ...
        {
            ViewsFrame viewsFrame;

            viewsFrame = Owner as ViewsFrame;
            viewsFrame.UpdateCurrentNode();
        }
