...
namespace UIRibbonTools
{
    ...
    partial class DropDownGalleryFrame : GalleryFrame
    {
        private static Image sample = ImageManager.DropDownGallerySample();

        public DropDownGalleryFrame()
        {
        ...
        protected override void InitComponentStep2()
        {
            ...
            LabelHeader.Text = "  Drop Down Gallery Properties";
            LabelHeader.ImageIndex = 15;
        }
