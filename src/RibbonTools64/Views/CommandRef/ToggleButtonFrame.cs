...
namespace UIRibbonTools
{
    ...
    partial class ToggleButtonFrame : CommandRefObjectFrame
    {
        private static Image sample = ImageManager.ToggleButtonSample();
        ...
        protected override void InitComponentStep2()
        {
            ...
            LabelHeader.Text = "  Toggle Button Properties";
            LabelHeader.ImageIndex = 1;
        }
