...
namespace UIRibbonTools
{
    partial class ViewsFrame
    {
        ...
        private MenuAction _actionAdd;
        private MenuAction _actionRemove;
        private MenuAction _actionMoveUp;
        private MenuAction _actionMoveDown;
        private MenuAction _actionAddButton;
        private MenuAction _actionAddToggleButton;
        private MenuAction _actionAddDropDownButton;
        private MenuAction _actionAddSplitButton;
        private MenuAction _actionAddCheckBox;
        private MenuAction _actionAddDropDownGallery;
        private MenuAction _actionAddSplitButtonGallery;
        private MenuAction _actionAddDropDownColorPicker;
        private MenuAction _actionAddMenuGroup;
        private MenuAction _actionAddQatButton;
        private MenuAction _actionAddQatToggleButton;
        private MenuAction _actionAddQatCheckBox;
        private MenuAction _actionAddQatComboBox;
        private MenuAction _actionAddQatDropDownGallery;
        private MenuAction _actionAddQatSplitButtonGallery;
        private MenuAction _actionAddQatInRibbonGallery;
        private MenuAction _actionAddRibbonSizeDefinition;
        private MenuAction _actionAddGroupSizeDefinition;
        private MenuAction _actionAddControlSizeDefinition;
        private MenuAction _actionAddControlSizeGroup;
        private MenuAction _actionAddColumnBreak;
        private MenuAction _actionAddRow;
        private MenuAction _actionAddGroup;
        private MenuAction _actionAddScale;
        private MenuAction _actionAddControlGroup;
        private MenuAction _actionAddComboBox;
        private MenuAction _actionAddSpinner;
        private MenuAction _actionAddInRibbonGallery;
        private MenuAction _actionAddFontControl;
        private MenuAction _actionAddFloatieFontControl;
        private MenuAction _actionAddTab;
        private MenuAction _actionAddTabGroup;
        private MenuAction _actionAddContextPopup;
        private MenuAction _actionAddMiniToolbar;
        private MenuAction _actionAddContextMenu;
        private MenuAction _actionAddContextMap;
        private MenuAction _actionAddMiniToolbarMenuGroup;

        private void InitMenuActions(IContainer components)
        {
            _actionList = new MenuActionList(components);

            _actionAdd = new MenuAction(components);
            _actionRemove = new MenuAction(components);
            _actionMoveUp = new MenuAction(components);
            _actionMoveDown = new MenuAction(components);
            _actionAddButton = new MenuAction(components);
            _actionAddToggleButton = new MenuAction(components);
            _actionAddDropDownButton = new MenuAction(components);
            _actionAddSplitButton = new MenuAction(components);
            _actionAddCheckBox = new MenuAction(components);
            _actionAddDropDownGallery = new MenuAction(components);
            _actionAddSplitButtonGallery = new MenuAction(components);
            _actionAddDropDownColorPicker = new MenuAction(components);
            _actionAddMenuGroup = new MenuAction(components);
            _actionAddQatButton = new MenuAction(components);
            _actionAddQatToggleButton = new MenuAction(components);
            _actionAddQatCheckBox = new MenuAction(components);
            _actionAddQatComboBox = new MenuAction(components);
            _actionAddQatDropDownGallery = new MenuAction(components);
            _actionAddQatSplitButtonGallery = new MenuAction(components);
            _actionAddQatInRibbonGallery = new MenuAction(components);
            _actionAddRibbonSizeDefinition = new MenuAction(components);
            _actionAddGroupSizeDefinition = new MenuAction(components);
            _actionAddControlSizeDefinition = new MenuAction(components);
            _actionAddControlSizeGroup = new MenuAction(components);
            _actionAddColumnBreak = new MenuAction(components);
            _actionAddRow = new MenuAction(components);
            _actionAddGroup = new MenuAction(components);
            _actionAddScale = new MenuAction(components);
            _actionAddControlGroup = new MenuAction(components);
            _actionAddComboBox = new MenuAction(components);
            _actionAddSpinner = new MenuAction(components);
            _actionAddInRibbonGallery = new MenuAction(components);
            _actionAddFontControl = new MenuAction(components);
            _actionAddFloatieFontControl = new MenuAction(components);
            _actionAddTab = new MenuAction(components);
            _actionAddTabGroup = new MenuAction(components);
            _actionAddContextPopup = new MenuAction(components);
            _actionAddMiniToolbar = new MenuAction(components);
            _actionAddContextMenu = new MenuAction(components);
            _actionAddContextMap = new MenuAction(components);
            _actionAddMiniToolbarMenuGroup = new MenuAction(components);
