...
namespace WinForms.Ribbon
{
    ...
    /// </summary>
    public sealed unsafe class RibbonDropDownGallery : RibbonStripItem,
        ...
        IPreviewEventsProvider
    {
        ...
        public RibbonDropDownGallery(RibbonStrip ribbon, uint commandId)
        ...
        private protected override void OnDestroyUICommand(uint commandId, UI_COMMANDTYPE typeID)
        {
            ...
            if (CommandType != CommandType.Unknown)
            {
                ...
                if (CommandType == CommandType.Collection && GalleryItemItemsSource != null)
                    GalleryItemItemsSource.Destroy();
                if (CommandType == CommandType.CommandCollection && GalleryCommandItemsSource != null)
