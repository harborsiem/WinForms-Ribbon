...
namespace WinForms.Ribbon
{
    ...
    {
        private static readonly EventKey s_ToggleChangedKey = new EventKey();
        ...
        public RibbonToggleButton(RibbonStrip ribbon, uint commandId)
        ...
        /// <summary>
        /// Event when the BooleanValue changed
        /// </summary>
        public event EventHandler<EventArgs>? ToggleChanged
        {
            add { EventSet.Add(s_ToggleChangedKey, value); }
            remove { EventSet.Remove(s_ToggleChangedKey, value); }
        }
        ...
        {
            EventSet.Raise(s_ToggleChangedKey, this, EventArgs.Empty);
            return HRESULT.S_OK;
        }
    }
}
